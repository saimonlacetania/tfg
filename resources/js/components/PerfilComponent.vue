                    ...
                    <div class="post">
                      ...
                      <div class="row mb-3">
                        <div class="col-sm-6">
                          <img
                            class="img-fluid"
                            src="../../../public/images/vendor/admin-lte/dist/photo1.png"
                            alt="Photo"
                          />
                        </div>
                        <!-- /.col -->
                          ...
                          <div class="row">
                            <div class="col-sm-6">
                              <img
                                ...
                                src="../../../public/images/vendor/admin-lte/dist/photo2.png"
                                alt="Photo"
                              />
                              <img
                                class="img-fluid"
                                src="../../../public/images/vendor/admin-lte/dist/photo3.jpg"
                                alt="Photo"
                              />
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                              <img
                                class="img-fluid mb-3"
                                src="../../../public/images/vendor/admin-lte/dist/photo4.jpg"
                                alt="Photo"
                              />
                              <img
                                class="img-fluid"
