                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <strong
                      ...
                      {{ this.botiga.poblacio }}</strong
                    >
                    <div class="text-muted">{{ this.botiga.direccio }}</div>
                    <small
                      ><p class="text-muted">
                        {{ this.botiga.provincia }}
                      </p></small
                    >
                  </li>
                  <li class="list-group-item">
                    <strong
                      ><i class="far fa-address-card mr-1"></i> Contacte</strong
                    >
                    <div class="text-muted">{{ this.botiga.email }}</div>
                    <small
                      ><p class="text-muted">{{ this.botiga.telf_1 }}</p></small
                    >
                  </li>
                  <li class="list-group-item">
                    <i class="fab fa-instagram mr-1"></i>
                    {{ this.botiga.instagram }}<br />
                    <i class="fab fa-facebook mr-1"></i>
                    {{ this.botiga.facebook }}<br />
              ...
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="#editarProductes"
                      data-toggle="tab"
                      >Editar productes</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#puja_producte" data-toggle="tab"
                      >Pujar productes</a
                    >
                  </li>
                </ul>
                    ...
                    <div class="card-body register-card-body">
                      <div class="form-group mb-3">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-10">
                            ...
                            <input
                              ...
                              v-model="$data.form_botiga.descripcio"
                            />
                          </div>
                          <div class="col-md-1"></div>
                        </div>
                          ...
                          <div class="col-md-5">
                            ...
                            <div class="input-group mb-3">
                              <input
                                ...
                                id="telf_1_botiga"
                                placeholder="Telèfon"
                                v-model="$data.form_botiga.telf_1"
                              />
                          ...
                          <div class="col-md-5">
                            ...
                            <div class="input-group mb-3">
                              <input
                                ...
                                id="telf_2_botiga"
                                placeholder="Telèfon"
                                v-model="$data.form_botiga.telf_2"
                              />
                              <div class="input-group-prepend">
                                <span class="input-group-text"
                                  ><i
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-10">
                            ...
                            <input
                              ...
                              id="email_botiga"
                              placeholder="Email"
                              v-model="$data.form_botiga.email"
                            />
                          </div>
                          <div class="col-md-1"></div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-10">
                            ...
                            <input
                              ...
                              v-model="$data.form_botiga.direccio"
                            />
                          </div>
                          <div class="col-md-1"></div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            ...
                            <input
                              ...
                              v-model="$data.form_botiga.cp"
                            />
                          </div>
                          <div class="col-md-4">
                            <div
                              class="input-group mb-3"
                              v-if="errors.poblacio"
                            >
                              <label class="col-form-label" for="number"
                                ><i class="far fa-times-circle"></i>
                            ...
                            <input
                              ...
                              v-model="$data.form_botiga.poblacio"
                            />
                          </div>
                          <div class="col-md-3">
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                              <input
                                ...
                                v-model="$data.form_botiga.instagram"
                              />
                              <div class="input-group-prepend">
                                <span class="input-group-text"
                                  ><i
                          ...
                          <div class="col-md-4">
                            ...
                            <div class="input-group mb-3">
                              <input
                                ...
                                v-model="$data.form_botiga.facebook"
                              />
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                              <input
                                ...
                                id="twitter_botiga"
                                placeholder="@twitter"
                                v-model="$data.form_botiga.twitter"
                              />
                              <div class="input-group-append">
                                <div
                                  class="input-group-text"
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <button
                              class="btn btn-block text-center mt-5 text-light zoom"
...
export default {
  ...
  mounted() {
    ...
    axios.get("/api/botiga").then((res2) => {
      ...
      this.form["id_botiga"] = this.botiga.user.id;
      this.form2["id_botiga"] = this.botiga.user.id;
  ...
  methods: {
    ...
    saveBotiga() {
      ...
      if (document.getElementById("img_perfil").files[0]) {
        that.form_botiga["img_perfil"] = document.getElementById(
          "img_perfil"
        ).files[0];
        formData.append("img_perfil", that.form_botiga["img_perfil"]);
      }
      if (document.getElementById("img_portada").files[0]) {
        that.form_botiga["img_portada"] = document.getElementById(
          "img_portada"
        ).files[0];
